...
namespace VentanaReflexion
{
    public class Ventana : Form
    {
        ...
        protected void button1_Click(object sender, EventArgs e)
        {
            ...
            Assembly Ensamblado = Assembly.LoadFile(@"C:\Users\Fredy\Desktop\Veterinaria\BibliotecaVeterinaria\BibliotecaVeterinaria\bin\Debug\BibliotecaVeterinaria.dll");
